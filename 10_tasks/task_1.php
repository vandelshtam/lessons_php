...
$array=[
    ['elem'=>'Report', 'attribute'=>'reports file'],
    ['elem'=>'Analytics','attribute'=>'analytics graphs'],
    ['elem'=>'Export','attribute'=>'export download'],
    ['elem'=>'Storage','attribute'=>'storage']
];
?>
<!DOCTYPE html>
<html lang="en">
                            ...
                            <div class="panel-content">
                                <div class="bg-warning-100 border border-warning rounded">
                                    ...
                                    {?>
                                        ...
                                        <span data-filter-tags="<?=$elem['attribute'];?>"><?=$elem['elem'];?></span>
                                        </li><?php                                  
                                    }?>    
                                    </ul>
