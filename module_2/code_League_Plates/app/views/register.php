...
<form class="row g-3 needs-validation" novalidate method="POST">
  <div class="col-md-4">
    ...
    <input type="text" class="form-control" id="validationCustom01" name='password' value="Mark" required>
  ...
  <div class="col-md-4">
    ...
    <input type="text" class="form-control" id="validationCustom02" name="username" value="Otto" required>
    <div class="valid-feedback">
      Looks good!
    </div>
  </div>
