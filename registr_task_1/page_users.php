...
<head>
    ...
    <body class="mod-bg-1 mod-nav-link">
        ...
        <main id="js-page-content" role="main" class="page-content mt-3">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <?php if(is_admin_in($pdo,$email)==true):?>
                    <a class="btn btn-success" href="add_users.php">Добавить</a>
                    <?php endif;?>
                ...
                <?php if(is_logged_in()==true):
                            ...
                            {
                                echo '<div class="row" id="js-contacts">
                                    <div class="col-xl-4">
                                ...
                                echo  '</a>';
                                    if($_SESSION['status']=='admin' OR $_SESSION['login']==$elem['email']): 
                                        echo   '<div class="dropdown-menu">
                                                ...
                                                <a href="delete.php?users_id='.$elem['id'].'" class="dropdown-item" onclick="return confirm(\'are you sure?\');">
